...
const storeListService = require('../services/shop.all')
...
function _getMockStore(id = null) {
  return {
    id: 666,
    name: '',
    address: 666,
...
module.exports = {
  ...
  //   const mockShop = _getMockStore(shopId)
  ...
  //   // const mockShop = _getMockStore(req.params.id)
